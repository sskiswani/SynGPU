...
Due to the fact that each neuron is integrated over $dt$ individually, the mebrane potential layer update step lends itself very naturally to being parallelized. 
